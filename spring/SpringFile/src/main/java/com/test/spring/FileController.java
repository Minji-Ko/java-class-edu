...
public class FileController {
	...
	public String addok(MultipartHttpServletRequest multi, Model model) {
		
		//1. 데이터 가져오기 (> 임시 폴더에 저장됌)
		//- 텍스트 데이터
		//- 파일 데이터
	...
	private String getFileName(String path, String filename) {
		...
		//path = "C:\class\spring\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\SpringFile\resources\files"
