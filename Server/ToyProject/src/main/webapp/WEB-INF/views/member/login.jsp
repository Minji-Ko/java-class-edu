	...
	<main>
		...
		<section>
			...
			<form method="POST" action="/toy/member/loginok.do">
				...
				<input type="submit" value="호호(hoho)" class="btn btn-success">
			</form>
			&nbsp;
			<form method="POST" action="/toy/member/loginok.do">
				<input type="hidden" name="id" value="area">
				<input type="hidden" name="pw" value="1234">
				<input type="submit" value="애리아(area)" class="btn btn-success">
			</form>
			&nbsp;
			<form method="POST" action="/toy/member/loginok.do">
				<input type="hidden" name="id" value="test">
				<input type="hidden" name="pw" value="1234">
				<input type="submit" value="아무개(test)" class="btn btn-success">
			</form>
			</div>
		</section>
	</main>
