...
public class Ex43_Override {
	...
	public static void main(String[] args) {
		...
		/*
		 	...
		 	면접
		 	- 메소드 오버로딩 vs 메소드 오버라이딩 ?  -> 아무상관 없는 기술
		 	- 김치찌개 vs 갤럭시 S22
		...
		//** 상속관계에 있는 클래스 > 같은 목적을 가지는 메소드 구현 > 반드시(***) 메소드 시그니처를 동일하게 만든다.
		...
		c1.hello();  //외부에서 보면 행동이 바뀐 것처럼 보인다.
...
class OverrideChild extends OverrideParent {
	...
	//자기 방식대로 인사를 하고 싶다!!! > 부모로부터 물려받은 메소드는 버려두고(안쓰고) 자신만의 메소드를 선언한다. > 비추천!!
//	public void hi() {
