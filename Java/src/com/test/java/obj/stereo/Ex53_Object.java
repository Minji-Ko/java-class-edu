...
public class Ex53_Object {
	...
	public static void main(String[] args) {
		...
		//Object 변수는 모든 자료형을 담을 수 있다 > 업캐스팅 > 상속관계에 있는 클래스끼리
		Object o10 = new SSS();
		...
		//System.out.println(o11 * 2);  //> 메모리 주소값 * 2
		
		//언박싱(UnBoxing)
		// > Object 변수에 들어있는 값형 데이터를 원래 값형으로 자료형을 변환
		System.out.println((int)o11 * 2);
		System.out.println((Integer)o11 * 2);
		
		int a = 10;		//int = int 	> 비용 보통
		Object b = 20;	//Object = int 	> 비용 비쌈(박싱과 언박싱 비용) > 해결책? 불완전하지만 "제네릭"
