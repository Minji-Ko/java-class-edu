		...
		/*
			...
			- 같은 목적을 가진 코드의 집합 > 1가지 목적을 위해 실행하는 코드들의 집합
		 	...
		 	2. F11(Debug) > Break Point 동작o
		 		a. F5 : 현재 라인에 메소드가 있다면 메소드 정의부 이동
...
//		*********** 프로그램 내에 같은 일을 하는 코드가 2군데 이상 동일하게 발견되면 절대 안된다!!!!! > 무조건 메소드!!!!!
//					> 질 낮은 프로그램 > 관리 불량(비용 발생 심함)
		System.out.println("반갑습니다.");
		System.out.println("반갑습니다.");
		System.out.println("반갑습니다.");
		System.out.println("반갑습니다.");
		System.out.println("반갑습니다."); //코드 재사용 아님!!
		
		//메소드 호출하기(실행하기, 사용하기)
		//-> hello라는 메소드가 가지는 코드를 실행해라!!
		hello(); //페이지 이동 > 제어가 이동한다.
