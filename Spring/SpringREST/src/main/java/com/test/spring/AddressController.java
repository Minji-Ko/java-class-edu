...
public class AddressController {
	...
	//public int add(@RequestBody AddressDTO dto) { //json사용시 @RequestBody 생략불가 
	...
	@GetMapping("/address")
	//@ResponseBody //자바 객체를 json 기반의 HTTP Body로 변환 > @RestController를 사용하는 경우 반환값에 자동으로 @ResponseBody 어노테이션이 붙음
